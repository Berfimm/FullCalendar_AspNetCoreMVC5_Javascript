    ...
    return (function (t) {
        ...
        function (t, e, n) {
            ...
            (e.default = o),
                ...
                (o.prototype.iconClasses = { close: "fc-icon-x", prev: "fc-icon-left-single-arrow", myCustomButton: "fc-icon-three-dots-vertical", next: "fc-icon-right-single-arrow", prevYear: "fc-icon-left-double-arrow", nextYear: "fc-icon-right-double-arrow" }),
                    ...
                    return (
                        ...
                        (e.prototype.renderSkeletonHtml = function () {
                            ...
                            return (
                                ...
                                t.getClass("widgetContent") +
                                '">' +
                                (this.dayGrid ? '<div class="fc-day-grid"></div><hr class="fc-divider ' + t.getClass("widgetHeader") + '"></hr>' : "") +
                                "</td></tr></tbody></table>"
                            );
                        }),
                        ...
                        (e.prototype.renderSlatRowHtml = function () {
                            for (var t, e, n, r = this.view, i = r.calendar, a = i.theme, l = this.isRTL, u = this.dateProfile, d = "", c = o.duration(+u.minTime), p = o.duration(0); c < u.maxTime;)
                                (t = i.msToUtcMoment(u.renderUnzonedRange.startMs).time(c)),
                                    ...
                                    (d += '<tr data-time="' + t.format("HH:mm:ss") + '"' + (e ? "" : ' class="fc-minor"') + ">" + (l ? "" : n) + '<td class="' + a.getClass("widgetContent") + '"></td>' + (l ? n : "") + "</tr>"),
                        ...
                        (t.prototype.render = function () {
                            ...
                            t
                                ? (e ? e.empty() : (e = this.el = r("<div class='fc-toolbar " + this.toolbarOptions.extraClasses + "'>")),
                                    e.append(this.renderSection("left")).append(this.renderSection("right")).append(this.renderSection("center")).append('<div class="fc-clear"></div>'))
                                : this.removeElement();
                        }),
                        (t.prototype.removeElement = function () {
                            this.el && (this.el.remove(), (this.el = null));
